james_estimator = function(v = y_f, theta,lam_james = 5000){
  ...
  output <<- james_em(dat = d2, groupings = 'county', m = m_0, knots = seq(round(n_dates))/round(n_dates), lambda = lam_james, 
